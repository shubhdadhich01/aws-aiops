...
`lab/python/capstone_audit.py`'s module docstring, delimited by two lines of 77
equal signs and beginning with 'DAY 10 FINDING CONTRACT — LOCKED AT CP2'.
...
SOURCE_OF_TRUTH = os.path.join(HERE, "lab", "python", "capstone_audit.py")
...
SOURCE_BEGIN = "DAY 10 FINDING CONTRACT — LOCKED AT CP2"
BANNER = "=" * 77
...
def extract_source_of_truth(path: str) -> str:
    """Return the LOCKED contract block from capstone_audit.py.
...
def main() -> int:
    ...
    if rc == 0:
        ...
        print(
            ...
            "propagate the source-of-truth from capstone_audit.py."
        )
    return rc
